...
public class ListExample1 {
	...
	// 		 크기가 자동으로 조절되는 형태 
	//		만약 수정, 삭제, 변경 사항이 많이 일어나는 경우에 적합하지 않음
	// 변경 사항이 많이 일어나는 경우에는 Linked를 사용하면 좋다.
	
	public static void main(String[] args) {
		// ArrayList의 기본 사용법
		ArrayList list = new ArrayList();	// 제너릭을 사용하지 않았기 때문에 Object타입으로 처리가 됨
...
//		System.out.println(list);
		...
		// indexOf : 데이터를 전달하면 해당 데이터의 인덱스를 반환. 못찾는 경우 (-1) 반환
		System.out.println(list.indexOf("홍길동"));
		System.out.println(list.indexOf("리스트에 없는 값"));
		
		// remove(index) : index 위치의 데이터를 삭제하고, 삭제한 값을 반환
		// remove(Object) : 해당 데이터를 삭제하고 결과를 반환(true or false, 삭제가 되었는지 or 안되었는지)
