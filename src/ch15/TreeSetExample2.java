...
public class TreeSetExample2 {
	...
	public static void main(String[] args) {
		...
		gym.add(new GymMember("박찬호", 1006));	// 이게 왜 0?
...
class GymMember implements Comparable<GymMember>{
	...
	public int compareTo(GymMember o) {
		// (*중요*) comparaTo 메서드 사용법 (매개변수로 비교 대상을 전달 받음)
		//  - 현재 인스턴스와 o의 자리를 바꾸고 싶으면 1을 리턴
		//  - 현재 인스턴스와 o의 자리를 그대로 유지하고 싶으면 -1을 리턴
