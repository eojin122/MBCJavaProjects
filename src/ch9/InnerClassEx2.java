...
public class InnerClassEx2 {
	...
	public static void main(String[] args) {
		...
		// staticB 객체 생성 (아래와 같이 접근이 가능한 이유 생각해보기)
		staticA.staticB b = new staticA.staticB();		//
		staticA.staticB b1 = staticA.field2;			// static인 경우
		staticA.staticB b2 = new staticA().field1;		// instance인 경우
		
		// static 메서드
//		staticA.staticB;		//이런식으로 접근 가능 (지금 예시는 로컬이라 큰 의미는 없지만 알고는 있어라)
		// 접근 방법 보기
//		staticA.staticB mb1 = new staticA().methon1();
//		staticA.staticB mb2 = staticA.methon2();
